...
export const mainnetTokens = {
  ...
  mvs: new Token(MAINNET, '0x98Afac3b663113D29dc2Cd8C2d1d14793692F110', 18, 'MVS', 'Multiverse', 'https://mvscoin.org'),
...
export const testnetTokens = {
  ...
  mvs: new Token(MAINNET, '0x394cF7368854Eec1A57aA3be30301cF00196b81B', 18, 'MVS', 'Multiverse', 'https://mvscoin.org'),
  busd: new Token(
    TESTNET,
