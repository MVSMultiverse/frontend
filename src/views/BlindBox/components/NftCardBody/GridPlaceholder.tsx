...
const GridPlaceholder: React.FC<GridPlaceholderProps> = ({ numItems = 3, ...props }) => (
  <Grid gridGap="16px" gridTemplateColumns={['1fr', null, null, 'repeat(3, 1fr)']} {...props}>
