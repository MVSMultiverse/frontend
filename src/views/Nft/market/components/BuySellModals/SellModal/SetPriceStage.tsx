...
const SetPriceStage: React.FC<SetPriceStageProps> = ({
  ...
  const bnbPrice = useBNBBusdTickerPrice()
  const priceAsFloat = parseFloat(price)
  const priceInUsd = bnbPrice.times(priceAsFloat).toNumber()
  ...
  const { tooltip, tooltipVisible, targetRef } = useTooltip(
    <>
      ...
      <Text>
        {t(
          '%percentage%% trading fee will be accumulated as the dividend pool distributing to SSR and SR holders every month.',
