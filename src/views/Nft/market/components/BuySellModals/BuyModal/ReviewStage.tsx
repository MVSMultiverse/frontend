...
import { Flex, Text, Button, ButtonMenu, ButtonMenuItem, Message, Link, Box } from '@pancakeswap/uikit'
import { FetchStatus } from 'hooks/useTokenBalance'
import { useTranslation } from 'contexts/Localization'
import { PANCAKE_BASE_URL } from 'config'
    ...
    <Box style={{ width: '100%' }}>
      <Flex px="24px" pt="24px" flexDirection="column">
        <Flex>
          ...
          <Flex flexDirection="column" justifyContent="space-evenly">
            ...
            <Flex justifyContent="space-between" alignItems="center">
              ...
              >
                {nftToBuy.rarity}-{nftToBuy.tokenId}
              </Button>
            </Flex>
          </Flex>
        </Flex>
        ...
        <Flex alignItems="center" flexDirection="column">
          ...
          <Button
            ...
            external
            variant="text"
            href={`${PANCAKE_BASE_URL}/swap?inputCurrency=BNB&outputCurrency=0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c`}
          >
            {t('Convert')}
          </Button>
        </Flex>
      ...
      <Flex px="24px" pb="24px" flexDirection="column">
        ...
        <Button
          ...
          external
          style={{ width: '100%' }}
          href={`${PANCAKE_BASE_URL}/swap?outputCurrency=BNB`}
          variant="secondary"
        >
