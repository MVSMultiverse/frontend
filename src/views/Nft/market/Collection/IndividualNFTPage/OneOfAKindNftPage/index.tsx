...
import { NftToken, UserNftInitializationState } from 'state/nftMarket/types'
import PageLoader from 'components/Loader/PageLoader'
import { useUserNfts } from 'state/nftMarket/hooks'
import MainNFTCard from './MainNFTCard'
import MainNFTSubCard from './MainNFTSubCard'
// import ManageNFTsCard from './ManageNFTsCard'
import useFetchUserNfts from '../../../../bag/hooks/useFetchUserNfts'
      ...
      >
        ...
        <Flex flexDirection="column" width="100%" alignItems="center">
          <Flex flexDirection="column" width="100%" justifyContent="flex-start">
            <MainNFTSubCard nft={nft} isOwnNft={isOwnNft} />
          </Flex>
          <OwnerCard nft={nft} isOwnNft={isOwnNft} />
          {/* <ManageNFTsCard
            nft={nft}
            isOwnNft={isOwnNft}
          ...
          {/* <DetailsCard nft={nft} contractAddress={collectionAddress} ipfsJson={nft?.marketData?.metadataUrl} /> */}
        </Flex>
      </TwoColumnsContainer>
