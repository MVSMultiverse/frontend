...
const OwnerCard: React.FC<OwnerCardProps> = ({ nft, isOwnNft }) => {
  ...
  const priceInUsd = bnbBusdPrice.times(parseFloat(nft.marketData?.currentAskPrice)).toNumber()
  ...
  return (
    <StyledCard>
        ...
        <>
          <TableHeading flex="0 1 auto" gridTemplateColumns="2fr 2fr 1fr" py="12px">
            <Flex alignItems="center">
              <Text textTransform="uppercase" color="textSubtle" bold fontSize="12px" px="12px">
                {t('Owner')}
              </Text>
            </Flex>
      ...
      {!isLoadingOwner && !owner && (
        <Flex justifyContent="center" alignItems="center" padding="12px">
