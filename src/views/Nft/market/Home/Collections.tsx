...
import { Flex, Grid, Heading, Text } from '@pancakeswap/uikit'
...
const Collections = () => {
  ...
  return (
    <>
      ...
      <Grid gridGap="16px" gridTemplateColumns={['1fr', '1fr', 'repeat(2, 1fr)', 'repeat(3, 1fr)']} mb="100px">
        ...
        {/* <HotCollectionCard disabled bgSrc="/images/no-collection-banner-sm.png" collectionName={t('Coming Soon')}>
